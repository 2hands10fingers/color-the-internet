...
with open(packetfile, "r+") as file:
	...
	for i in data:
		try:
			...
			timeunit = math.ceil(float(timepoint) * 1000000)
			babyobject = {'color': parsecolor, 'size': math.floor(int(sizepoint)) / 10}
...
print(colorarray, timearray, addvel, motherobject)
